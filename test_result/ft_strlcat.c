...
src and dest. but beside that concating action will take place, and at first it make sure that 
...
size_t ft_strlcat(char *dest, const char *src, size_t size){
    ...
    while(dest[dest_length] != '\0' && dest_length < size) dest_length++;
    if(dest_length == size ) return (src_length + dest_length);
...
int main(){
    ...
    printf("the size of buffer is %lu but it want to create this %d.\n", sizeof(test1), length);
    return 0;
}
*/
